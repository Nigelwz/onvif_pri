...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.94 2019-10-25 06:59:31 GMT")
...
{	(void)type;
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "tdn:ByeResponse"))
		{	*type = SOAP_TYPE__tdn__ByeResponse;
			return soap_in__tdn__ByeResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "tdn:Bye"))
		{	*type = SOAP_TYPE__tdn__Bye;
			return soap_in__tdn__Bye(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "tdn:ProbeResponse"))
		{	*type = SOAP_TYPE__tdn__ProbeResponse;
			return soap_in__tdn__ProbeResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "tdn:Probe"))
		{	*type = SOAP_TYPE__tdn__Probe;
			return soap_in__tdn__Probe(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "tdn:HelloResponse"))
		{	*type = SOAP_TYPE__tdn__HelloResponse;
			return soap_in__tdn__HelloResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "tdn:Hello"))
		{	*type = SOAP_TYPE__tdn__Hello;
			return soap_in__tdn__Hello(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE__tdn__ByeResponse:
		return soap_out__tdn__ByeResponse(soap, "tdn:ByeResponse", id, (const struct wsdd__ResolveType *)ptr, "");
	case SOAP_TYPE__tdn__Bye:
		return soap_out__tdn__Bye(soap, "tdn:Bye", id, (const struct wsdd__ByeType *)ptr, "");
	case SOAP_TYPE__tdn__ProbeResponse:
		return soap_out__tdn__ProbeResponse(soap, "tdn:ProbeResponse", id, (const struct wsdd__ProbeMatchesType *)ptr, "");
	case SOAP_TYPE__tdn__Probe:
		return soap_out__tdn__Probe(soap, "tdn:Probe", id, (const struct wsdd__ProbeType *)ptr, "");
	case SOAP_TYPE__tdn__HelloResponse:
		return soap_out__tdn__HelloResponse(soap, "tdn:HelloResponse", id, (const struct wsdd__ResolveType *)ptr, "");
	case SOAP_TYPE__tdn__Hello:
		return soap_out__tdn__Hello(soap, "tdn:Hello", id, (const struct wsdd__HelloType *)ptr, "");
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in ./generated/soapC.c\n", tag ? tag : "", type));
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE___tdn__Hello:
		...
		break;
	case SOAP_TYPE__tdn__ByeResponse:
		soap_serialize__tdn__ByeResponse(soap, (const struct wsdd__ResolveType *)ptr);
		break;
	case SOAP_TYPE__tdn__Bye:
		soap_serialize__tdn__Bye(soap, (const struct wsdd__ByeType *)ptr);
		break;
	case SOAP_TYPE__tdn__ProbeResponse:
		soap_serialize__tdn__ProbeResponse(soap, (const struct wsdd__ProbeMatchesType *)ptr);
		break;
	case SOAP_TYPE__tdn__Probe:
		soap_serialize__tdn__Probe(soap, (const struct wsdd__ProbeType *)ptr);
		break;
	case SOAP_TYPE__tdn__HelloResponse:
		soap_serialize__tdn__HelloResponse(soap, (const struct wsdd__ResolveType *)ptr);
		break;
	case SOAP_TYPE__tdn__Hello:
		soap_serialize__tdn__Hello(soap, (const struct wsdd__HelloType *)ptr);
		break;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__ByeResponse(struct soap *soap, const struct wsdd__ResolveType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__ByeResponse(soap, tag ? tag : "tdn:ByeResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__Bye(struct soap *soap, const struct wsdd__ByeType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__Bye(soap, tag ? tag : "tdn:Bye", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__ProbeResponse(struct soap *soap, const struct wsdd__ProbeMatchesType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__ProbeResponse(soap, tag ? tag : "tdn:ProbeResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__Probe(struct soap *soap, const struct wsdd__ProbeType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__Probe(soap, tag ? tag : "tdn:Probe", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__HelloResponse(struct soap *soap, const struct wsdd__ResolveType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__HelloResponse(soap, tag ? tag : "tdn:HelloResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_put__tdn__Hello(struct soap *soap, const struct wsdd__HelloType *a, const char *tag, const char *type)
{
	if (soap_out__tdn__Hello(soap, tag ? tag : "tdn:Hello", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
